...
//
// The input checkout must be the pinned version below. Terminal vendors the SVGs
// and generated lookup table, so building Terminal never downloads or generates
// icon resources.
...
const outputDirectory = resolve('terminal/MaterialFileIcons');
const swiftOutputPath = resolve('terminal/MaterialFileIcon.swift');
...
writeFileSync(
  ...
  `Material Icon Theme ${upstreamVersion}\n`
    ...
    + 'Terminal includes a curated catalog of 300 logical file icons.\n',
);
