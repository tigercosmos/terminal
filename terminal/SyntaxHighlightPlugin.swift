...
//  terminal
//
//  terminal's own STTextView highlighting plugin. It reuses STTextView-Plugin-Neon's
...
//
//  Languages are named by terminal's own `SyntaxLanguage`, not the plugin's
...
final class SyntaxHighlightCoordinator {
    ...
    init(
        ...
        // Empty fonts table (see SyntaxHighlighting.theme) → this keeps terminal's
