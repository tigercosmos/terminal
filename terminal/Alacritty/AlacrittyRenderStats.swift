...
/// Frame timing for the Alacritty backend, reported when `TERMINAL_RENDER_STATS`
...
final class AlacrittyRenderStats: @unchecked Sendable {
    ...
    private static let isEnabled = ProcessInfo.processInfo.environment["TERMINAL_RENDER_STATS"] != nil
    ...
    private func report() {
        ...
        NSLog(String(
            format: "terminal-render drawn=%d skipped=%d rows=%d mean=%.3fms worst=%.3fms",
