...
struct SourceTextEditor: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        // colors as rendering attributes; the font stays terminal's (see
...
private final class RestorableScrollView: NSScrollView {
    ...
    /// Temporary: set TERMINAL_SCROLLER_DEBUG=1 to trace scroller geometry.
    private func logScroller(_ tag: String) {
        guard ProcessInfo.processInfo.environment["TERMINAL_SCROLLER_DEBUG"] != nil else { return }
