...
/// Replaces the default cursor, unless the program selected its own with DECSCUSR.
void terminal_alacritty_set_cursor_style(TerminalHandle *handle, uint8_t shape, bool blinking);
