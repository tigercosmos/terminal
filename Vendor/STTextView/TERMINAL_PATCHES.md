...
+            // terminal patch: after an attribute change (font/color) invalidates layout,
...
Don't re-add these to the package — they live on the app side, in [`terminal/SourceTextEditor.swift`](../../terminal/SourceTextEditor.swift), and are configuration of a stock STTextView, not modifications to it:
